      ...
      {isOpen ? (
        <>
          <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none ">
            <div className="rounded relative w-auto my-6 mx-auto max-w-[600px]">
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col  w-[1000px] sm:max-w-[40%] md:max-w-[60%] lg:max-w-[80%] xl:max-w-[100%] h-full bg-black outline-none focus:outline-none">
